...
import { usersIdByUid } from "../../store/slices/users/usersSlice";
...
const SearchInputByUId = (props: SearchInputInterface): JSX.Element => {
    ...
    const [idClicked, setIdIsClecked] = useState(false);
    ...
    useEffect(() => {
        if (users.useridByIdLoading) {
            setShowSpinner(true);
        } else {
            setShowSpinner(false);
        }
    }, [users.useridByIdLoading]);
...
export default SearchInputByUId;
